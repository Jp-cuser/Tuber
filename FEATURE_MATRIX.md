...
| STT-004      | Speech Input    | Continuous microphone                              | Required    | Phase 5  | Done        | Restart/stop lifecycle; repeated silence segments; cleanup; contract and UI tests            |
| TTS-001      | TTS             | VOICEVOX                                           | Required    | Phase 6  | Done        | Adapter/query/synthesis/speakers; protected API; controls/playback; contract/integration/E2E |
| TTS-002      | TTS             | Koeiromap                                          | Required    | Phase 6  | Done        | Server-key adapter; X/Y/style; JSON/binary audio; protected route; contract/UI/E2E           |
| TTS-003      | TTS             | Google Text-to-Speech                              | Required    | Phase 6  | Done        | Official REST mapping; header auth; voices; controls; endpoint validation; contract/UI/E2E   |
| TTS-004      | TTS             | Style-Bert-VITS2                                   | Required    | Phase 6  | Done        | POST /voice; model/speaker/style/SDP/rate; URL policy; optional key; contract/UI/E2E         |
| TTS-005      | TTS             | AivisSpeech                                        | Required    | Phase 6  | Done        | AudioQuery/synthesis/speakers; style/tempo/phoneme controls; URL policy; contract/UI/E2E     |
